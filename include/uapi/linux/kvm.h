...
#define KVM_CAP_HYPERV_TLB_FLUSH_INHIBIT 240
#define KVM_CAP_HYPERV_HCALL_FAULT_EXIT 242
#define KVM_CAP_HYPERV_XMM_EXIT 241
#define KVM_CAP_FAULT_EXIT_INSN_LEN 243
...
#define KVM_SET_REGISTER_FILTER	_IOW(KVMIO,  0xf7, struct kvm_register_filter)
